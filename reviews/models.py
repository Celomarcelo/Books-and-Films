...
class Profile(models.Model):
    ...
    image = models.ImageField(upload_to='profile_images/', default='https://res.cloudinary.com/dr6m3xv0e/image/upload/v1723217421/default_profile_ztyuck.jpg')  # Profile image with a default setting
